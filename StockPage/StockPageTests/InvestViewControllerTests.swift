//
//  InvestViewControllerTests.swift
//  StockPageTests
//
...
class InvestViewControllerTests: XCTestCase {
    
    var viewController: InvestViewController!
    ...
    func testNavigationBarItems() {
        ...
        XCTAssertEqual(titleLabel.text, "Invest", "Title label should display 'Invest'")
