...
class FundViewControllerTests: XCTestCase {
    
    var viewController: FundViewController!

    override func setUpWithError() throws {
        try super.setUpWithError()
        viewController = FundViewController()
    ...
    func testNavigationBarItems() {
        ...
        XCTAssertEqual(titleLabel.text, "Funds", "Title label should display 'Fund'")
